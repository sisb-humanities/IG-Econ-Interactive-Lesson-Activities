...
(function () {
  ...
  // ---- alias for activities built with the {unit, activity, complete, total} object-call
  // convention (window.SISBTracker.log(opts)) — normalises onto the same log() above.
  window.SISBTracker = {
    log: function (opts) {
      opts = opts || {};
      ...
      log(opts.unit, opts.activity, detail || "");
    },
    getName: getName,
